...
- Practice German dates
- Practice German ordinal numbers
- Audio and/or text
- No coding required!
...
| -------------------------------------------------------------- |- |
Before you start the app, make sure that VLC https://www.videolan.org/<br>is installed.|<img src="50_800x800.png" width="400"/> |

| _,.-'``'-.,_,.'`` Step 2 ``'.,_,.-'``'-.,_|Screenshot|
| -------------------------------------------------------------- |- |
Choose if you only want to hear the date, or hear it as well.|<img src="100_800x800.png" width="400"/> |

| _,.-'``'-.,_,.'`` Step 3 ``'.,_,.-'``'-.,_|Screenshot|
| -------------------------------------------------------------- |- |
Write your answer in DD.MM.YYYY format! If it is right, you will get a<br>point.|<img src="150_800x800.png" width="400"/> |
